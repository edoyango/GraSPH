...
open(1,file="output_data/f_xv"//number//".dat")
open(2,file="output_data/f_state"//number//".dat")
open(3,file="output_data/f_other"//number//".dat")
open(4,file="output_data/f_force"//number//".dat")

if (n .eq. 1.d0) then
  open(70,file="output_data/time.dat")
else
  open(70,file="output_data/time.dat",status="old",position="append")
endif
